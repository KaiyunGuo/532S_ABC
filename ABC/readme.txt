...
The datasets are too large for upload. To execute model, download and preprocess WSI slides first and store in "WSIvectors/slide_id_name.pt", download genomic data and store as "tcga_gbmlgg_all_clean.csv"
